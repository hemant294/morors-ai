    ...
    return (
        <div className='main-home'>
            <div className='hero-image-group'>
                ...
                >
                    <div className='car-tag-head'>
                        <p className='card-tag' style={{marginLeft: "-30px"}}>SUVs</p>
                        <img src={img5} alt="" className='hero-images' />
                    </div>
                </motion.div>
                <motion.div
                    className='hero-images-head'
                ...
                >
                    <div className='car-tag-head'>
                        <p className='card-tag' style={{marginLeft: "-40px", marginTop: "-40px"}}>Top Brands</p>
                        <img src={img1} alt="" className='hero-images' style={{ marginBottom: "40px" }} />
                    </div>
                    <div className='car-tag-head'>
                        <p className='card-tag' style={{marginLeft: "-40px"}}>Rental Cars</p>
                ...
                >
                    <div className='car-tag-head'>
                        <p className='card-tag' style={{marginLeft: "80px", marginTop: "-100px"}}>Populor Models</p>
                        <img src={img2} alt="" className='hero-images' style={{ marginTop: "-25px", marginBottom: '30px' }} />
                    </div>
                    <div className='car-tag-head'>
                        <img className='card-robot-tag' src={hello} alt="say hello" />
                        {/* <p className='card-tag' style={{marginLeft: "80px", marginTop: "-100px"}}>Hello</p> */}
                ...
                >
                    <div className='car-tag-head'>
                        <p className='card-tag' style={{marginLeft: "110px", marginTop: "0px"}}>Luxury Cars</p>
                        <img src={img6} alt="" className='hero-images' style={{ marginTop: "60px", marginBottom: "40px" }} />
                    </div>
                    <div className='car-tag-head'>
                        <p className='card-tag' style={{marginLeft: "110px", marginTop: "-20px"}}>Cars of sell</p>
                        <img src={img4} alt="" className='hero-images' />
                    </div>
                </motion.div>
                <motion.div
                    className='hero-images-head'
                ...
                >
                    <div className='car-tag-head'>
                        <p className='card-tag' style={{marginLeft: "134px", marginTop: "0px"}}>SUVs</p>
                        <img src={img5} alt="" className='hero-images' />
                    </div>
                </motion.div>
            </div>
